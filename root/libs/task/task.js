...
module.exports = class event {
  ...
  init () {
    let self = this
    return co(function *() {
      let result = yield util.getTaskList()
  ...
  restart (id, rule, params) {
    ...
    if (target) {
      ...
      if (j) {
        ...
        let handle = this.taskMap[moduleName][target.handle](target.id, target.params)
